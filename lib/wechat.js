...
function Wechat(name, options) {
    ...
    this.dir = options.dir //微信端返回文件存储位置
 ...
 */
exports.on = function(mdu, action, url, aop) {
        ...
        Object.defineProperty(Wechat.prototype, mdu, {
            get: (function(_mdu) {
                ...
                return function() {
                    ...
                    console.log('actions::::::::', actions.__wc.cn)
